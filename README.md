...
4. ** Eliminar Productos:** Permite dar de baja productos que ya no se manejan o que fueron registrados por error.
5. ** Vender Productos (Simulación):** Deduce las cantidades del inventario activo basándose en las salidas o ventas realizadas.
